...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.19\linewidth]{imgs/hw_1_2.png}
    \includegraphics[width=0.19\linewidth]{imgs/hw_1_3.png}
    \includegraphics[width=0.19\linewidth]{imgs/hw_1_4.png}
    \includegraphics[width=0.19\linewidth]{imgs/hw_1_5after.png}
    \includegraphics[width=0.19\linewidth]{imgs/hw_1_6.png}
...
\begin{equation}
C = \alpha_0 C_0 + \alpha_1 (1 - \alpha_0) + (1 - \alpha_0) (1 - \alpha_1) B.
\end{equation}

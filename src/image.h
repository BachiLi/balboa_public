...
/// Applies gamma correction (gamma = 2.2) to the image before reading.
...
/// Supported formats: png, bmp, tga, jpg.
/// Applies gamma correction (gamma = 2.2) to the image before writing.
